...
$(document).ready(function() {
    ...
    $('#subir_imagen').uploadify({
        ...
        'script'    : base_url + 'uploadify_controller/subir_fotos',//el script que procesa la subida
        ...
        'cancelImg' : base_url + 'img/cancel.png',//imagen cancelar subida
        'buttonText': 'Seleccionar',//nombre del botón
        'sizeLimit': 400000000,//tamaño máximo
        'folder'    : 'uploads',//la carpeta
        'fileExt'     : '*.jpg;*.gif;*.jpeg*;*.png;*.JPG;*.JEPG;*.bmp;*.doc;*.pdf;',//extensiones aceptadas
        ...
        'onSelect'    : function(event,ID,fileObj) {
            var filter = /(.jpg|.jpeg|.png|.gif|.bmp|.JPG;|.JEPG|.doc|.pdf;)/;
            // utilizamos test para comprobar si el parametro valor cumple la regla
            if(!(filter.test(fileObj.type.toLowerCase()))){
                jAlert('Sólo se aceptan archivos .jpg, .jpeg, .png, .bmp , .gif, .doc y .pdf');
                return false;
            }

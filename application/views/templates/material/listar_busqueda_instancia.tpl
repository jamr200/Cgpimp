					...
					{if $instancias != "no hay datos"}
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td width="124">{$fila->nombre_tipo_material}</td>
								...
								<td width="98">
									<a href="{base_url()}material_controller/visualizar_instancia_material/?id={$fila->id}"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="{base_url()}material_controller/modificar_instancia_material2/?id={$fila->id}"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="{base_url()}material_controller/historico_instancia_material2/?id={$fila->id}"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
							{/foreach}
						</table>
						...
						<!-- ************************-->
						<a href="{base_url()}material_controller/buscar_instancia_material" class="btn btn-primary">Cancelar</a>
						<!-- ************************-->
					{else}
						<div class="col-md-12">

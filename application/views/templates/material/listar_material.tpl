...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<form id="generapdflistadomaterial" action="{base_url()}material_controller/GeneraPdfListadoMaterial" method="POST">
				<fieldset class="fieldset">
					<legend>Listado de materiales</legend>
					<!-- ************************-->
					{if $listado_materiales != "no hay datos"}
						<table class="table table-bordered table-striped">
							...
							{foreach from=$listado_materiales item=fila}
							<tr>
								<td width="46">{$fila->id}</td>
								<td width="245">{$fila->nombre_tipo_material}</td>

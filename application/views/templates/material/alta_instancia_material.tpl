...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
			...
			{/if}
			<form id="addinstmaterial" action="{base_url()}material_controller/addInstanciaMaterial" method="POST">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control" id="pedido" name="pedido">
								<option value=""></option>
								{section name=ped loop=$pedido}
									<option value="{$pedido[ped]['id']}">{$pedido[ped]['nombre_pedido']}</option>
								{/section}
							</select>
						</div>
					</div>

...
<div class="container">
    <div class="row">
        ...
        <form id="visualizamaterial" method="POST">
            ...
            <legend>Información de la instancia de material con id {$instancia->id}</legend>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">{$instancia->relacionado}</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">{$instancia_asociada}</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                <!-- ************************-->
                <a href="{base_url()}material_controller/modificar_instancia_material2/?id={$instancia->id}" class="btn btn-primary">Modificar</a>

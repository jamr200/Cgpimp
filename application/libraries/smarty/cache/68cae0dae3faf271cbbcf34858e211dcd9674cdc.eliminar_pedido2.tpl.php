<?php /*%%SmartyHeaderCode:22112526a875795a338-84521064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68cae0dae3faf271cbbcf34858e211dcd9674cdc' => 
    array (
      0 => 'application\\views\\templates\\pedido\\eliminar_pedido2.tpl',
      1 => 1382696141,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '22112526a875795a338-84521064',
  'variables' => 
  array (
    'pedido' => 0,
    'proveedor' => 0,
  ...
  'unifunc' => 'content_526a8757b82b71_49107184',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526a8757b82b71_49107184')) {function content_526a8757b82b71_49107184($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
    <div class="row">
        ...
        <form id="eliminapedido" method="POST">
            ...
            <legend>Informacion del pedido con id 2</legend>
                <!-- ************************-->
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <p class="form-control-static">pedido 1</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Esto es un pedido nuevo y le incorporo est</p>
                    </div>
                 </div>
                <!-- ************************-->
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">pixelprint2</p>
                    </div>
                </div>
                <!-- ************************-->
                <a href="http://localhost/pfcdata/pedido_controller/deletePedido2/?id_pedido=2" class="btn btn-primary">Eliminar</a>

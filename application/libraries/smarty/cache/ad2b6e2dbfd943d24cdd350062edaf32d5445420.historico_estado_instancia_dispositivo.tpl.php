<?php /*%%SmartyHeaderCode:572752ea3e95ca39a5-99073346%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad2b6e2dbfd943d24cdd350062edaf32d5445420' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\historico_estado_instancia_dispositivo.tpl',
      1 => 1390910092,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '572752ea3e95ca39a5-99073346',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52ea3e95e5bef8_96173917',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ea3e95e5bef8_96173917')) {function content_52ea3e95e5bef8_96173917($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="historicoinstdispositivo" action="http://localhost/pfcdata/dispositivo_controller/historicoInstanciaDispositivo" method="POST">
				<fieldset class="fieldset">
					<legend>Histórico de estados de instancia de dispositivo</legend>
					<!-- ************************-->
					<div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label for="muestra_historico_instancia_dispositivo"></label>
							<div class="controls" id="muestra_historico_instancia_dispositivo" name="muestra_historico_instancia_dispositivo">
							</div>
						</div>
					</div>
					<!-- ************************-->
...
$(document).ready(function(){
	...
	$("#tipo_dispositivo").change(function () {
		$("#tipo_dispositivo option:selected").each(function () {
			//alert($(this).val());
				...
				$("#muestra_historico_instancia_dispositivo").html("");
			});
		});
	})
	...
	$("#combo_instancia").change(function () {
		$("#combo_instancia option:selected").each(function () {
			//alert($(this).val());
				elegido=$(this).val();
				$.post("muestra_historico_instancia_dispositivo", { elegido: elegido }, function(data){
				$("#muestra_historico_instancia_dispositivo").html(data);
			});
		});
	})
});

<?php /*%%SmartyHeaderCode:1838752e9223d1b4f30-07936376%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '598ecc7b90cee5b99ef3a3b5d3b4470f669a022f' => 
    array (
      0 => 'application\\views\\templates\\proveedor\\modificar_proveedor2.tpl',
      1 => 1390913223,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1838752e9223d1b4f30-07936376',
  'variables' => 
  array (
    'proveedor' => 0,
  ),
  ...
  'unifunc' => 'content_52e9223d31a3b2_75870541',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e9223d31a3b2_75870541')) {function content_52e9223d31a3b2_75870541($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            <form id="update2proveedor" action="http://localhost/pfcdata/proveedor_controller/updateProveedor" method="POST">
                <fieldset class="fieldset">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" value="Pixelprint" placeholder="Nombre">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefono_fijo" name="telefono_fijo" value="665670576" placeholder="Telefono fijo">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefono_movil" name="telefono_movil" value="665670576" placeholder="Telefono movil">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="pixelprint@gmail.com" placeholder="Email">
                        </div>
                     </div>
                    <!-- ************************-->
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="direccion" name="direccion" value="C/Cruz del cordero, 25" placeholder="Direccion">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="contacto" name="contacto" value="Nacho" placeholder="Nombre contacto">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefono_contacto" name="telefono_contacto" value="" placeholder="Telefono Contacto">
                        </div>
                    </div>
                    <!-- ************************-->
                    <!--campo oculto con la url de la página-->
                    <input type="hidden" value="1" name="combo_proveedor" id="combo_proveedor"/>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">

<?php /*%%SmartyHeaderCode:10062525508d57b6433-41333405%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '10d9515da42bfd6c570a99400c921c116ef43c1b' => 
    array (
      0 => 'application\\views\\templates\\material\\eliminar_instancia_material.tpl',
      1 => 1380706998,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10062525508d57b6433-41333405',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_525508d5b07587_76269934',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_525508d5b07587_76269934')) {function content_525508d5b07587_76269934($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									<form id="deleteinstmaterial" action="http://localhost/pfcdata/material_controller/deleteInstanciaMaterial" method="POST">
						...
						<div class="form-group">
							...
							<select class="form-control" name="tipo_material" id="tipo_material">
								<option value=""></option>
																	...
																	<option value="1">Fusor</option>
																	<option value="5">lampara</option>
																	<option value="6">nuevoMaterial</option>
																	<option value="8">prueba_material1</option>
																	<option value="9">prueba_material2</option>
																	<option value="7">pruebo_mat</option>

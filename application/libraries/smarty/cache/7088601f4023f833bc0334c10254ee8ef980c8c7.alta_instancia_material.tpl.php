<?php /*%%SmartyHeaderCode:1888652e7d3808cf582-60453978%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7088601f4023f833bc0334c10254ee8ef980c8c7' => 
    array (
      0 => 'application\\views\\templates\\material\\alta_instancia_material.tpl',
      1 => 1390924668,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1888652e7d3808cf582-60453978',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52e7d380a813c2_38114345',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e7d380a813c2_38114345')) {function content_52e7d380a813c2_38114345($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="addinstmaterial" action="http://localhost/pfcdata/material_controller/addInstanciaMaterial" method="POST">
				<fieldset class="fieldset">
					<legend>Instancia de material</legend>
					<!-- ************************-->
					<div class="col-md-8">
					...
					<div class="col-md-8">
						<div class="form-group">
							<label class="control-label" for="marca_material">Marca</label>
					...
					<div class="col-md-8">
						<div class="form-group">
							<label class="control-label" for="modelo_material">Modelo</label>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="part_number" name="part_number" value="" placeholder="Part_number">
						</div>
					</div>
					<!-- ************************-->
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label" for="num_serie">Numero de Serie</label>
							<input type="text" class="form-control" id="num_serie" name="num_serie" value="" placeholder="Num_serie">
						</div>
					</div>
					<!-- ************************-->
					<div class="col-md-12">
		...
		<div class="modal-dialog">
			...
			<div class="modal-body">
				<form class="FormMarca" id="FormMarca">
					<fieldset>
					<div class="form-group">
						<label class="control-label" for="tipo_material2">Tipo de Dispositivo</label>
	...
	$(document).ready(function(){
		$('#addinstmaterial').validate({
			...
			messages: 
			{
				...
				num_serie: "El numero de serie es obligatorio y debe tener al menos 3 caracteres.",
...
<script>
	$(document).ready(function(){
		// Parametros para el tipo_material3

<?php /*%%SmartyHeaderCode:444352ea3eafe41ab1-94290412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '94271120bb02b9d2fe3fa817e88fe313dc94f43f' => 
    array (
      0 => 'application\\views\\templates\\ubicacion\\eliminar_ubicacion.tpl',
      1 => 1390913653,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '444352ea3eafe41ab1-94290412',
  'variables' => 
  array (
    'nombre_edificio' => 0,
    'nombre_habitacion' => 0,
  ...
  'unifunc' => 'content_52ea3eb004d967_78130402',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ea3eb004d967_78130402')) {function content_52ea3eb004d967_78130402($_smarty_tpl) {?><!DOCTYPE html>
            ...
            <legend>Informacion de la ubicación</legend>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Ayuntamiento</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Almacén 1</p>
                    </div>
                 </div>
                <!-- ************************-->
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">estantería 1</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="balda">Balda</label>
                        <p class="form-control-static">balda 2</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                <!-- ************************-->
                <a href="http://localhost/pfcdata/ubicacion_controller/deleteUbicacion/?id=5" class="btn btn-primary">Eliminar</a>
                <a href="http://localhost/pfcdata/ubicacion_controller/listar_ubicacion" class="btn btn-default">Cancelar</a>
                <!-- ************************-->
            </fieldset>
        </form>
        </div>

<?php /*%%SmartyHeaderCode:2268452e92ea9b364a1-48801845%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4af5a6807c3f13dce5b51a5de2443d746a5484f' => 
    array (
      0 => 'application\\views\\templates\\material\\visualizar_instancia_material.tpl',
      1 => 1391013424,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2268452e92ea9b364a1-48801845',
  'variables' => 
  array (
    'instancia' => 0,
    'tipo' => 0,
    ...
    'nombre_ped' => 0,
    'nombre_estado' => 0,
    'instancia_asociada' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52e92ea9cd1be8_32013662',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92ea9cd1be8_32013662')) {function content_52e92ea9cd1be8_32013662($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
        <form id="visualizamaterial" method="POST">
            <fieldset class="fieldset">
            <legend>Información de la instancia de material con id 1</legend>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">CAT35E35</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">MC35E35</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">2013-07-02</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">pedido1</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Averiado</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="inst_dispositivo">Instancia asociada</label>
                        <p class="form-control-static"></p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                <!-- ************************-->
                <a href="http://localhost/pfcdata/material_controller/modificar_instancia_material2/?id=1" class="btn btn-primary">Modificar</a>

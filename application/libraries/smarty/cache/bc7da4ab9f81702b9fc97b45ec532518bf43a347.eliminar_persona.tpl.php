<?php /*%%SmartyHeaderCode:2099352e7d5a3cc05b3-70420123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc7da4ab9f81702b9fc97b45ec532518bf43a347' => 
    array (
      0 => 'application\\views\\templates\\personal\\eliminar_persona.tpl',
      1 => 1381761641,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2099352e7d5a3cc05b3-70420123',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52e7d5a4016564_01760008',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e7d5a4016564_01760008')) {function content_52e7d5a4016564_01760008($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="deletepersona" action="http://localhost/pfcdata/persona_controller/deletePersona" method="POST">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control" id="combo_persona" name="combo_persona">
								<option value=""></option>
																	<option value="1">Alfonso Cordero Benasayag</option>
																	<option value="2">Antonio José Hierro Gutierrez</option>
															</select>
						</div>
					</div>
					<!-- ************************-->

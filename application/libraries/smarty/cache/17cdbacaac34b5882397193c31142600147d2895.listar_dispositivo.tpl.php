<?php /*%%SmartyHeaderCode:2245552e92c26cbb000-69991764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17cdbacaac34b5882397193c31142600147d2895' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\listar_dispositivo.tpl',
      1 => 1390910138,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2245552e92c26cbb000-69991764',
  'variables' => 
  array (
    'listado_dispositivos' => 0,
    'fila' => 0,
    'paginacion' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52e92c26eb8111_77753282',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92c26eb8111_77753282')) {function content_52e92c26eb8111_77753282($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<form id="generapdflistadodispositivo" action="http://localhost/pfcdata/dispositivo_controller/GeneraPdfListadoDispositivo" method="POST">
					...
					<!-- ************************-->
							...
							<tr>
								...
								<th width="322">Modelo</th>
														...
														<tr>
								<td width="46">1</td>
								<td width="245">Impresoras</td>
								<td width="321">Hp</td>
								<td width="322">Psc 750</td>
							</tr>
														<tr>
								<td width="46">2</td>
								<td width="245">Impresoras</td>
								<td width="321">Hp</td>
								<td width="322">Psc 800</td>
							</tr>
														<tr>
								<td width="46">3</td>
								<td width="245">Impresoras</td>
								<td width="321">Epson</td>
								<td width="322">stylus dx3800</td>
							</tr>
														<tr>
								<td width="46">4</td>
								<td width="245">Impresoras</td>
								<td width="321">Epson</td>
								<td width="322">stylus sx130</td>
							</tr>
														<tr>
								<td width="46">5</td>
								<td width="245">Impresoras</td>
								<td width="321">Canon</td>
								<td width="322">ix6550</td>
							</tr>
														<tr>
								<td width="46">6</td>
								<td width="245">Impresoras</td>
								<td width="321">Epson</td>
								<td width="322">sx235w</td>
							</tr>
													</table>					
						<!-- ************************-->

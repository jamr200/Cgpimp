<?php /*%%SmartyHeaderCode:1653152e92bf379ae00-40425535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '213c5bbf38027826690ccedc80c7e7b8170028f7' => 
    array (
      0 => 'application\\views\\templates\\departamento\\listar_departamento.tpl',
      1 => 1390911499,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1653152e92bf379ae00-40425535',
  'variables' => 
  array (
    'listado_departamentos' => 0,
    'fila' => 0,
    'paginacion' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52e92bf390d5d5_90460750',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92bf390d5d5_90460750')) {function content_52e92bf390d5d5_90460750($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<form id="generapdflistadodepartamentos" action="http://localhost/pfcdata/departamento_controller/GeneraPdfListadoDepartamento" method="POST">
					...
					<!-- ************************-->
							...
							<tr>
								...
								<th width="98">Acciones</th>
														...
														<tr>
								<td width="306">Informática, Innovación Tecnológica y Reprografía</td>
								<td width="290">nuevas.tecnologias@velezmalaga.es</td>
								<td width="120">952559130</td>
								<td width="120">952559350</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/modificar_departamento2/?id=1"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/eliminar_departamento2/?id=1"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="306">Contratación y Patrimonio</td>
								<td width="290">contratacion@velezmalaga.es</td>
								<td width="120">952559169</td>
								<td width="120">952559105</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/modificar_departamento2/?id=2"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/eliminar_departamento2/?id=2"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="306">Asesoría Jurídica y Asuntos Judiciales</td>
								<td width="290">asuntosjudiciales@velezmalaga.es</td>
								<td width="120">952559194</td>
								<td width="120">952559105</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/modificar_departamento2/?id=3"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/eliminar_departamento2/?id=3"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="306">Deportes</td>
								<td width="290">deportes@velezmalaga.es</td>
								<td width="120">952558055</td>
								<td width="120">952505756</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/modificar_departamento2/?id=4"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/departamento_controller/eliminar_departamento2/?id=4"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
													</table>					

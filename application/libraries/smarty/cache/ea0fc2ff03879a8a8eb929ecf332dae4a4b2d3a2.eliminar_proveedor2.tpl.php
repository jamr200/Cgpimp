<?php /*%%SmartyHeaderCode:726152e7d522dc1227-67261914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea0fc2ff03879a8a8eb929ecf332dae4a4b2d3a2' => 
    array (
      0 => 'application\\views\\templates\\proveedor\\eliminar_proveedor2.tpl',
      1 => 1390913049,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '726152e7d522dc1227-67261914',
  'variables' => 
  array (
    'proveedor' => 0,
  ),
  ...
  'unifunc' => 'content_52e7d522f3f911_18822364',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e7d522f3f911_18822364')) {function content_52e7d522f3f911_18822364($_smarty_tpl) {?><!DOCTYPE html>
            ...
            <legend>Informacion del proveedor</legend>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Pixelprint</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">665670576</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">pixelprint@gmail.com</p>
                    </div>
                 </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">C/Cruz del cordero, 25</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Nacho</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-6">
                ...
                <!-- ************************-->
                <a href="http://localhost/pfcdata/proveedor_controller/deleteProveedor2/?id_proveedor=1" class="btn btn-primary">Eliminar</a>
                <a href="http://localhost/pfcdata/proveedor_controller/listar_proveedor" class="btn btn-default">Cancelar</a>
                <!-- ************************-->
            </fieldset>
        </form>
        </div>

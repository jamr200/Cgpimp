<?php /*%%SmartyHeaderCode:323052e92d619fa736-49821041%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff2c21c6e3ce764f85438cca398116aa788d5f98' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\visualizar_instancia_dispositivo.tpl',
      1 => 1390910335,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '323052e92d619fa736-49821041',
  'variables' => 
  array (
    'instancia' => 0,
    'tipo' => 0,
  ...
  'unifunc' => 'content_52e92d61b84586_65484304',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92d61b84586_65484304')) {function content_52e92d61b84586_65484304($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
    <div class="row">
        ...
        <form id="visualizadispositivo" method="POST">
            ...
            <legend>Información de la instancia de dispositivo con id 3</legend>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="Tipo">Tipo</label>
                        <p class="form-control-static">Impresoras</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Canon</p>
                    </div>
                 </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">ix6550</p>
                    </div>
                </div>
                <!-- ************************-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">4895B008AA</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">B004N5J9V4</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">2013-01-03</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="form-control-static">Disponible</p>
                    </div>
                </div>
                <!-- ************************-->
                <div class="clearfix visible"></div>
                <!-- ************************-->
                <a href="http://localhost/pfcdata/dispositivo_controller/modificar_instancia_dispositivo2/?id=3" class="btn btn-primary">Modificar</a>

<?php /*%%SmartyHeaderCode:47505253e1e6ada860-34418890%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28b40afc4dc38dbe7c5b243cc3e17b9f0caa5eed' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\eliminar_tipo_dispositivo.tpl',
      1 => 1380643976,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '47505253e1e6ada860-34418890',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_5253e1e6c28020_93045096',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5253e1e6c28020_93045096')) {function content_5253e1e6c28020_93045096($_smarty_tpl) {?><!DOCTYPE html>
...
<!-- Lo tengo comentado porque si pulso el boton para guardar cambios me salta mensaje de que no hay seleccionados
	<p class="alert alert-error" style="margin: 1px;"><i class="icon-exclamation-sign"></i>Hay tipos de dispositivo que no han sido borrados, ya que existen dispositivos asociados.
-->
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
							<p class="alert alert-danger"><span class="glyphicon glyphicon-exclamation-sign"></span>Hay tipos de dispositivo que no han sido borrados, ya que existen dispositivos asociados.</p>
									<form id="deletetipodispositivo" action="http://localhost/pfcdata/dispositivo_controller/deleteTipoDispositivo" method="POST">

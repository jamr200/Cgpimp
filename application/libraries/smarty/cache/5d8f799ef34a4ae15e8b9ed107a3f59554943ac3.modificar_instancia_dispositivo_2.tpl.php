<?php /*%%SmartyHeaderCode:3197952e91de0827cb3-26165776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d8f799ef34a4ae15e8b9ed107a3f59554943ac3' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\modificar_instancia_dispositivo_2.tpl',
      1 => 1391008770,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3197952e91de0827cb3-26165776',
  'variables' => 
  array (
    'advertencia' => 0,
    'error' => 0,
  ...
  'unifunc' => 'content_52e91de0a0a488_06687923',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e91de0a0a488_06687923')) {function content_52e91de0a0a488_06687923($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
												...
												<form id="update2instdispositivo" action="http://localhost/pfcdata/dispositivo_controller/updateInstanciaDispositivo" method="POST">
				<fieldset class="fieldset">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="part_number" name="part_number" value="C8426A" placeholder="Part_number">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="num_serie" name="num_serie" value="MY57E9206M" placeholder="Num_serie">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fecha" name="fecha" value="1997-02-06" placeholder="Fecha">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="hidden" id="id_inst_dispositivo" name="id_inst_dispositivo" value="1">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">

<?php /*%%SmartyHeaderCode:1441952e92c295bbdc1-29424835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50b8d65bfd73f4ead77e28ec855511e25e331dbc' => 
    array (
      0 => 'application\\views\\templates\\material\\listar_material.tpl',
      1 => 1382434470,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1441952e92c295bbdc1-29424835',
  'variables' => 
  array (
    'listado_materiales' => 0,
    'fila' => 0,
    'paginacion' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52e92c297af0d6_37980343',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92c297af0d6_37980343')) {function content_52e92c297af0d6_37980343($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<form id="generapdflistadomaterial" action="http://localhost/pfcdata/material_controller/GeneraPdfListadoMaterial" method="POST">
				<fieldset class="fieldset">
					<legend>Listado de materiales</legend>
					<!-- ************************-->
							...
							<tr>
								...
								<th width="322">Modelo</th>
														...
														<tr>
								<td width="46">1</td>
								<td width="245">Cartuchos de tinta</td>
								<td width="321">Hp</td>
								<td width="322">35</td>
							</tr>
														<tr>
								...
								<td width="322">t281</td>
							</tr>
														<tr>
								<td width="46">4</td>
								<td width="245">Cartuchos de tinta</td>
								<td width="321">Epson</td>
								<td width="322">t282</td>
							</tr>
													</table>					
						<!-- ************************-->
						<div class="col-md-12">

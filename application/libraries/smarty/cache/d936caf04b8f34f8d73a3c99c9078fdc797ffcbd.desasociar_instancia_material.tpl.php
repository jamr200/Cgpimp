<?php /*%%SmartyHeaderCode:588152e7d2e03520f9-72347211%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd936caf04b8f34f8d73a3c99c9078fdc797ffcbd' => 
    array (
      0 => 'application\\views\\templates\\material\\desasociar_instancia_material.tpl',
      1 => 1390912157,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '588152e7d2e03520f9-72347211',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52e7d2e05a5dd8_60799749',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e7d2e05a5dd8_60799749')) {function content_52e7d2e05a5dd8_60799749($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="desasociainstmaterial" action="http://localhost/pfcdata/material_controller/desasocia_dispositivo_material" method="POST">
				<fieldset class="fieldset">
					<legend>Desasociar instancia de material</legend>
						<!-- ************************-->
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="desasocia_instancia_dispositivo">Instancias</label>
									<select class="form-control" name="desasocia_instancia_dispositivo" id="desasocia_instancia_dispositivo">
									</select>
							</div>
						</div>
						<!-- ************************-->
						<div class="col-lg-6">
							<div class="form-group">
								<label for="desasocia_instancia_material">Instancias</label>
									<select class="form-control" name="desasocia_instancia_material" id="desasocia_instancia_material">
									</select>
							</div>
						</div>
						<!-- ************************-->
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="estado_nuevo">Estado</label>
									<select class="form-control" name="estado_nuevo" id="estado_nuevo">
									<option value=""></option>
					...
					<div class="col-md-8">
						<div class="form-group">
							<button type="submit" class="btn btn-primary">Desasociar</button>
...
$(document).ready(function(){
	...
	$("#tipo_material").change(function () {
		$("#tipo_material option:selected").each(function () {
			//alert($(this).val());
				...
				$("#desasocia_instancia_material").html("");
			});
		});
	})
	...
	$("#modelo_material").change(function () {
		$("#modelo_material option:selected").each(function () {
			//alert($(this).val());
				elegido=$(this).val();
				$.post("desasocia_instancia_material", { elegido: elegido }, function(data){
				$("#desasocia_instancia_material").html(data);
			});
		});
	})
});
...
$(document).ready(function(){
	...
	$("#tipo_dispositivo").change(function () {
		$("#tipo_dispositivo option:selected").each(function () {
			//alert($(this).val());
				...
				$("#desasocia_instancia_dispositivo").html("");
			});
		});
	})
	...
	$("#modelo_dispositivo").change(function () {
		$("#modelo_dispositivo option:selected").each(function () {
			//alert($(this).val());
				elegido=$(this).val();
				$.post("desasocia_instancia_dispositivo", { elegido: elegido }, function(data){
				$("#desasocia_instancia_dispositivo").html(data);
			});
		});
	})
});
...
<script>
    $(document).ready(function(){
    	...
    	$("#desasocia_instancia_dispositivo").select2();
    	$("#tipo_material").select2();
    	$("#marca_material").select2();
    	$("#modelo_material").select2();
    	$("#desasocia_instancia_material").select2();
    	$("#estado_nuevo").select2();
    });
</script>
<?php }} ?>
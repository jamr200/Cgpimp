<?php /*%%SmartyHeaderCode:271752e7d484ee9786-36851532%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '483ef8c5f224770d4d49afaa11a1a6789948f292' => 
    array (
      0 => 'application\\views\\templates\\departamento\\eliminar_departamento2.tpl',
      1 => 1390911476,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '271752e7d484ee9786-36851532',
  'variables' => 
  array (
    'departamento' => 0,
  ),
  ...
  'unifunc' => 'content_52e7d48512f721_05243011',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e7d48512f721_05243011')) {function content_52e7d48512f721_05243011($_smarty_tpl) {?><!DOCTYPE html>
            ...
            <legend>Información del departamento</legend>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <p class="form-control-static">nuevas.tecnologias@velezmalaga.es</p>
                        </div>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <p class="form-control-static">952559130</p>
                        </div>
                    </div>
                </div>
                <!-- ************************-->
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <p class="form-control-static">952559350</p>
                        </div>
                    </div>
                </div>
                <!-- ************************-->
                <a href="http://localhost/pfcdata/departamento_controller/deleteDepartamento2/?id_departamento=1" class="btn btn-primary">Eliminar</a>

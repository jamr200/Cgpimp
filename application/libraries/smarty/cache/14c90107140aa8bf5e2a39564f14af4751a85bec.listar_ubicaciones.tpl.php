<?php /*%%SmartyHeaderCode:2600252f0db5b4fb2d2-39171228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '14c90107140aa8bf5e2a39564f14af4751a85bec' => 
    array (
      0 => 'application\\views\\templates\\ubicacion\\listar_ubicaciones.tpl',
      1 => 1391014863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2600252f0db5b4fb2d2-39171228',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
    'listado_ubicaciones' => 0,
    'fila' => 0,
    'paginacion' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52f0db5b676877_61239161',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f0db5b676877_61239161')) {function content_52f0db5b676877_61239161($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
									<form id="generapdflistadoubicacion" action="http://localhost/pfcdata/ubicacion_controller/GeneraPdfListadoUbicacion" method="POST">
					...
					<!-- ************************-->
							...
							<tr>
								...
								<th width="98">Acciones</th>
														...
														<tr>
								<td width="195">4 // C12C514223 // GC7443355</td>
								<td width="185">Ayuntamiento</td>
								<td width="152">Almacén 1</td>
								<td width="152">estantería 1</td>
								<td width="152">balda 2</td>
								<td width="98">
									...
									<a href="http://localhost/pfcdata/ubicacion_controller/eliminar_ubicacion/?id=4"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="195">1 // CAT35E35 // MC35E35</td>
								<td width="185">Ayuntamiento</td>
								<td width="152">Almacén 1</td>
								<td width="152">estantería 1</td>
								<td width="152">balda 2</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/ubicacion_controller/eliminar_ubicacion/?id=5"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="195">5 // C11C613213 // GC7Y323452</td>
								<td width="185">Ayuntamiento</td>
								<td width="152">Almacén 1</td>
								<td width="152">estantería 1</td>
								<td width="152">balda 1</td>
								<td width="98">
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/ubicacion_controller/eliminar_ubicacion/?id=6"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
													</table>					

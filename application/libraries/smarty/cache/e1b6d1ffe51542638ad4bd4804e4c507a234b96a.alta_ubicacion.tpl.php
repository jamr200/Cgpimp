<?php /*%%SmartyHeaderCode:3019352e926783f2cd8-60132617%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1b6d1ffe51542638ad4bd4804e4c507a234b96a' => 
    array (
      0 => 'application\\views\\templates\\ubicacion\\alta_ubicacion.tpl',
      1 => 1391011425,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3019352e926783f2cd8-60132617',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52e926785c60c3_67644182',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e926785c60c3_67644182')) {function content_52e926785c60c3_67644182($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="estableceubicacion" action="http://localhost/pfcdata/ubicacion_controller/addUbicacion" method="POST">
					...
					<!-- ************************-->
						...
						<div class="col-md-6">
							...
							<!-- ************************-->
								...
								<div class="col-md-2">
									<!--Boton modal 2-->
									<a data-toggle="modal" href="#myModal2" class="btn" id="modal2" rel="tooltip" title="Añade habitación"><span class="glyphicon glyphicon-plus"></span></a>
								</div>
							<!-- ************************-->
								<div class="col-md-10">
									<div class="form-group">

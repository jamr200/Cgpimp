<?php /*%%SmartyHeaderCode:2877152e92c1de369e8-63870077%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de85c6796bb70a3227e9ae77eb9842451004a8e1' => 
    array (
      0 => 'application\\views\\templates\\personal\\listar_persona.tpl',
      1 => 1390912886,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2877152e92c1de369e8-63870077',
  'variables' => 
  array (
    'listado_personas' => 0,
    'fila' => 0,
  ...
  'unifunc' => 'content_52e92c1e0769e7_46424414',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92c1e0769e7_46424414')) {function content_52e92c1e0769e7_46424414($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<form id="generapdflistadopersona" action="http://localhost/pfcdata/persona_controller/GeneraPdfListadoPersona" method="POST">
					...
					<!-- ************************-->
							...
							<tr>
								...
								<th width="98">Acciones</th>
														...
														<tr>
								<td width="130">Alfonso</td>
								<td width="168">Cordero</td>
								<td width="168">Benasayag</td>
								<td width="104">54443321k</td>
								<td width="266">acordero@velezmalaga.es</td>
								<td width="98">
									<a href="http://localhost/pfcdata/persona_controller/visualizar_persona/?id=1"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/persona_controller/modificar_persona2/?id=1"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/persona_controller/eliminar_persona2/?id=1"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
														<tr>
								<td width="130">Antonio José</td>
								<td width="168">Hierro</td>
								<td width="168">Gutierrez</td>
								<td width="104">66655543J</td>
								<td width="266">ahierro@velezmalaga.es</td>
								<td width="98">
									<a href="http://localhost/pfcdata/persona_controller/visualizar_persona/?id=2"><span class="glyphicon glyphicon-eye-open"></span></a>
									<a href="http://localhost/pfcdata/persona_controller/modificar_persona2/?id=2"><span class="glyphicon glyphicon-pencil"></span></a>
									<a href="http://localhost/pfcdata/persona_controller/eliminar_persona2/?id=2"><span class="glyphicon glyphicon-remove"></span></a>
									<a href="" class="btn disabled"><span class="glyphicon glyphicon-stats"></span></a>
								</td>
							</tr>
													</table>					

<?php /*%%SmartyHeaderCode:3087452e92340622677-66778924%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e316d90bfab9f5dd1cc0fc82cb5cc618b528ebc' => 
    array (
      0 => 'application\\views\\templates\\pedido\\modificar_pedido2.tpl',
      1 => 1391010484,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3087452e92340622677-66778924',
  'variables' => 
  array (
    'pedido' => 0,
    'proveedor' => 0,
  ...
  'unifunc' => 'content_52e92340794e00_81351733',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e92340794e00_81351733')) {function content_52e92340794e00_81351733($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            <form id="update2pedido" action="http://localhost/pfcdata/pedido_controller/updatePedido" method="POST">
                ...
                <legend>Información de Pedido</legend>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" value="pedido1" placeholder="Nombre">
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="observaciones" id="observaciones" rows="3">Esto es un pedido nuevo</textarea>
                        </div>
                    </div>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="proveedor">Selecciona Proveedor: </label>
                             <select class="form-control" id="proveedor" name="proveedor">
                                    <option value="1">Pixelprint</option>';
                                                                            <option value="2">Axartoner</option>
                                                                </select>
                        </div>
                    </div>
                    <!-- ************************-->
                    <!--campo oculto con la url de la página-->
                    <input type="hidden" value="1" name="combo_pedido" id="combo_pedido"/>
                    <!-- ************************-->
                    <div class="col-md-12">
                        <div class="form-group">

<?php /*%%SmartyHeaderCode:2481552e91c2898a8c5-18775659%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e7f73934c00d3194feec3d49b4d266c871cb7aa' => 
    array (
      0 => 'application\\views\\templates\\dispositivo\\alta_instancia_dispositivo.tpl',
      1 => 1390923064,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2481552e91c2898a8c5-18775659',
  'variables' => 
  array (
    'error' => 0,
    'success' => 0,
  ...
  'unifunc' => 'content_52e91c28beb3f0_26418485',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52e91c28beb3f0_26418485')) {function content_52e91c28beb3f0_26418485($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
									...
									<form id="addinstdispositivo" action="http://localhost/pfcdata/dispositivo_controller/addInstanciaDispositivo" method="POST">
				<fieldset class="fieldset">
					<legend>Instancia de dispositivo</legend>
					<!-- ************************-->
					<div class="col-md-8">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label" for="num_serie">Número de Serie</label>
		    ...
		    <div class="modal-content">
		    	<!-- ************************-->	     
		       	<div class="modal-header">
		       		<h3 class="modal-title">Ingresar nuevo tipo de dispositivo</h3>
		       	</div>
		       	<!-- ************************-->
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#addinstdispositivo').validate({
			errorElement: "span",
			errorClass: 'help-block',
			rules: 
			{
				tipo_dispositivo: {required: true},
				marca_dispositivo: {required: true},
				modelo_dispositivo: {required: true},
